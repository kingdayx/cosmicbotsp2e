...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar absolute right-0 flex h-20 flex-row md:mb-2 shadow-lg bg-transparent  text-neutral-content  bg-opacity-100">
        ...
        {/* Nav Links */}
        {/* Wallet & Settings */}
        <div className="navbar-end absolute right-1">
